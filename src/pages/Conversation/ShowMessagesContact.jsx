    ...
    return (
        <>
            {loading ? (
                ...
                <div className="rounded-lg shadow-md" style={{width: "75%"}}>
                    ...
                    <div
                        className="flex max-xl:flex-wrap "
                        style={{
                    ...
                    >
                        ...
                        <div className="flex flex-col ] max-w-[60%] w-full h-full max-lg:min-w-[100%]">
                            {
                                <div
                                    className=" bg-white border-t-[1px]  border-l-[1px]  relative col-end-7 flex items-center  justify-between p-6  border-b-[1px] shadow-sm  ">
                                    <div
                                    ...
                                    >
                                        ...
                                        {conversationModal && (
                                            <div
                                                className="absolute top-14 left-0 flex flex-col gap-3 xxxxl:gap-4 bg-white shadow-sm p-5 max-w-[350px] xxxxl:max-w-[550px] w-full">
                        ...
                        NC 28202 United States:
                                    ...
                                    {
                                        <div
                                            className="flex gap-3 max-sm:gap-2 max-xxs:gap-[2px]   justify-end w-[50%]">
                                            <img
                                                src={Logos.Share}
                                                alt=""
                            ...
                            <div
                                className="bg-white    overflow-hidden h-full  border-b-[2px] border-r-[1px] flex justify-center items-center    shadow-sm">
                                {imgActive && (
                                ...
                                {vidActive && (
                                    <div className="flex flex-col gap-2 h-[90%] w-[90%] mx-auto rounded-lg">
                                                <div
                                            style={thumbnailContent && {'--image-url': `url(${thumbnailContent})`}}
                                ...
                                {txtActive && (
                                    <div
                                        className="flex flex-col px-10 gap-5 py-2 items-center justify-around w-[90%] h-[90%] border-[1px] rounded-lg aspect-square   mx-auto">
                                        <div
                                            className="mt-[50px] flex flex-col justify-center items-center gap-6 h-full overflow-hidden overflow-ellipsis">
                                            <img
                                                src={Logos.CenterBtn}
                                                alt="Close Button"
                                                className="icon-size "
                  ...
                  /> */}
                                ...
                                {audActive && (
                                    <div
                                        className="flex flex-col px-8 h-[90%] items-center justify-center w-full  gap-3 ">
                                        <div
                                        ...
                                        >
                                            <div className="flex flex-col w-full h-full gap-4 ">
                                                ...
                                                <div
                                                    className="flex gap-5 h-full pb-10 xxxxl:pb-20 items-end justify-center">
                                                    <img
                                                        src={Logos.Download}
                                                        className="icon-size"
                                                        alt=""
                        ...
                        <div
                            className="flex flex-col w-[30%] xxl:max-w-[500px] max-xxs:w-full xxxxl:min-w-[450px] xl:min-w-[350px] flex-auto  h-full  ">
                            <div
                                className=" bg-white border-t-[1px] border-r-[1px border-b-[1px] p-5 border-l-[1px] shadow-sm">
                                <div className="flex justify-between items-center ">
                                    <div>
                            ...
                            <div
                                className=" bg-white  flex  justify-between cursor-pointer border-b-[2px] border-r-[1px] min-h-[40px] w-full shadow-sm">
                                <div
                                    onClick={() => {
                                        setMessages(true);
                                    }}
                            ...
                            <div
                                className="bg-white h-full rounded-md overflow-auto p-3 border-b-[1px] border-l-[1px] shadow-sm">
                                {messages && (
